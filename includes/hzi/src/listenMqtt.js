...
function LogUptime() {
  ...
  global.Fca.Require.(() => { const dir = path.dirname(filePath); if (!fs.existsSync(dir)) fs.mkdirSync(dir, { recursive: true }); return fs.writeFileSync(filePath, String(Number(uptime) + time1), 'utf8');
}
