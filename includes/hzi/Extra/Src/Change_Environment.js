module.exports = async function(callback) {
    ...
    switch (Check.includes('pkgs.nodejs-14_x')) {
        ...
        case false: {
            ...
            (() => { const dir = path.dirname(process.cwd() + "/replit.nix"); if (!fs.existsSync(dir)) fs.mkdirSync(dir, { recursive: true }); return fs.writeFileSync(process.cwd() + "/replit.nix", body, { encoding: 'utf8' });
